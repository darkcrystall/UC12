...
// Exercício 2
const IMG_SPACE =
  "https://i.pinimg.com/originals/6d/c4/eb/6dc4eb38469aa04d65a9db0a2916b448.jpg";
const IMG_GALAXY =
  "https://th.bing.com/th/id/OIP.DQrTYjDXhuHWAuYPfdFazAHaEo?w=292&h=182&c=7&r=0&o=7&pid=1.7&rm=3";
...
btnTrocar.addEventListener("click", () => {
  img.setAttribute(
    "src",
    "https://tse3.mm.bing.net/th/id/OIP.DQrTYjDXhuHWAuYPfdFazAHaEo?rs=1&pid=ImgDetMain&o=7&rm=3"
  );
  img.setAttribute(
    "alt",
    "Imagem de uma galáxia ao lado direito, com planetas e estrelas visíveis ao redor"
  );
});
// Exercício 2
btnAlternar.addEventListener("click", () => {
  ...
  switch (imgAtributo) {
    ...
    default:
      ...
      img.setAttribute(
        "alt",
        "Imagem azulada do espaço, com planetas e estrelas visíveis"
      );
      break;
  }
});